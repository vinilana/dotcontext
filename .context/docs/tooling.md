...
4. **Use MCP for context creation and AI generation.** Standalone CLI generation is no longer supported. Install MCP with `npx dotcontext mcp:install` and use your AI tool to create, fill, or refresh context.
