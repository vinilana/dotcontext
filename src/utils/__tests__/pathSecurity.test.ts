...
describe('PathValidator', () => {
    ...
    describe('validatePath', () => {
        ...
        it('should allow nested paths within workspace', () => {
            const result = validator.validatePath('src/harness/application/context/contextTools.ts');
            expect(result).toBe(path.join(workspaceRoot, 'src', 'harness', 'application', 'context', 'contextTools.ts'));
        });
