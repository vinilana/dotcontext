...
import type { SemanticContext, DetectedFunctionalPatterns } from '../../../../../adapters/out/semantic/types';
import type { StackInfo } from '../../../intelligence/stack/stackDetector';
...
export class CodebaseMapGenerator {
  ...
  private buildNavigationSection(repoStructure: RepoStructure, stackInfo?: StackInfo): NavigationHints {
    ...
    const mainLogicPatterns = ['src/harness', 'src/core', 'src/lib', 'lib', 'src/modules'];
